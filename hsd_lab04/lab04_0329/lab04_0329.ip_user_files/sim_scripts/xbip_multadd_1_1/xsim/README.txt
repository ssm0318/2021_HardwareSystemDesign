...
#
# Generated by export_simulation on Wed Mar 31 21:31:04 +0900 2021
#
################################################################################
...
'-reset_run' switch to the './xbip_multadd_1.sh' script.

./xbip_multadd_1.sh -reset_run
...
./xbip_multadd_1.sh -noclean_files

For more information on the script, please type './xbip_multadd_1.sh -help'.
