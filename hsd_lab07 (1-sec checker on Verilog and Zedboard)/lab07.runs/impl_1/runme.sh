...
HD_PWD='/home/jaewon/Documents/lab07/lab07.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log one_sec_checker.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source one_sec_checker.tcl -notrace
