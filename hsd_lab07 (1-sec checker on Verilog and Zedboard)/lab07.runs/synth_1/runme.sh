...
HD_PWD='/home/jaewon/Documents/lab07/lab07.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log one_sec_checker.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source one_sec_checker.tcl
